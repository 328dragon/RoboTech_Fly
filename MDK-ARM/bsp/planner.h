...
public:
    ...
    SimpleStatus_t &LoactaionCloseControl(const odom_t &target_odom, float max_linear, float max_angular, const odom_t &target_error = {0.1, 0.4, 0.1}, bool clearodom = false);
...
private:
    ...
    float _max_linear_acc =3.0f; // 最大线加速度
